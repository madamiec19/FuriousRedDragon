...
import 'package:furious_red_dragon/data/bloc/add_item/add_item_bloc.dart';
import 'package:furious_red_dragon/data/bloc/add_item/add_item_event.dart';
import 'package:furious_red_dragon/data/bloc/add_item/add_item_event.dart';
...
class AddItemBloc extends Bloc<AddItemEvent, AddItemState> {
  ...
  AddItemBloc(this._authenticationRepository) : super(const AddItemState()) {
  ...
  Future<void> _onEmailAddressChanged(
          LoginEmailAddressChanged event, Emitter<AddItemState> emit) async =>
      emit(state.copyWith(
