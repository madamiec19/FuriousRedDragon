          ...
          child: SingleChildScrollView(
            child: BlocConsumer<AddEditItemBloc, AddEditItemState>(
                ...
                builder: (context, state) {
                  print(state.addEditItemStatus);
                  print(state.idBuilding);
                  return Column(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (value) {
                                  context.read<AddEditItemBloc>().add(
                                      AddEditItemBrandChanged(brand: value));
                                },
                                decoration: const InputDecoration(
                                  filled: true,
                                  fillColor: kPageBackgroundColor,
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: DropdownMenu(
                                  width: kScreenWidth * 0.4,
                                  textStyle: kGlobalTextStyle,
                                  initialSelection: state.idBuilding,
                                  onSelected: (newValue) {
                                    context.read<AddEditItemBloc>().add(
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: DropdownMenu(
                                  width: kScreenWidth * 0.4,
                                  textStyle: kGlobalTextStyle,
                                  enabled: state.idBuilding != -1 ||
                                      state.addEditItemStatus ==
                                          AddEditItemStatus.addingInRoom,
                                  initialSelection:
                                      state.floor != -3 ? state.floor : '',
                                  onSelected: (newValue) {
                                    context.read<AddEditItemBloc>().add(
