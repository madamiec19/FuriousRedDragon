          ...
          ElevatedButton(
            onPressed: () async {
              try {
                ...
                _showSnackBar('Weryfikacja nieudana. Sprawdź poprawność tokena.');
              }
            },
                ...
                BigRedButton(
                  onTap: () async {
                        ...
                        try {                     
                              ...
                              await supabase.auth.signUp(password: passwordController.text, email: emailController.text); 
                          ...
                          // Error registration
                          _showSnackBar('Rejestracja nieudana.Wystąpił nieznany wyjątek: ${error.toString()}');
                          }
                    emailController.text = '';                
                    passwordController.text = '';
                    repeatPasswordController.text = '';
